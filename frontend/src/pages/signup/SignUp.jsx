    ...
    <div className='flex flex-col items-center justify-center min-w-96 mx-auto'>
      <div className='w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'> 
        <h1 className='text-3xl font-semibold text-center text-gray-300'>
					Sign Up
          <span className= 'text-indigo-300'> Twizzy Chat</span>
        </h1>

        <form onSubmit={handleSubmit}>
          <div>
            <label className='label p-2'>
              <span className = 'text-indigo-200 text-base label-text'>Full Name</span>
            </label>
          ...
          <div>
          <label className='label p-2'>
              <span className = 'text-indigo-200 text-base label-text'>Username</span>
            </label>
          ...
          <div>
            <label className="label">
              <span className = 'text-indigo-200 text-base label-text'>Password</span>
            </label>
            <input 
              type='password' 
        ...
        <div>  
          <label className="label">
              <span className = 'text-indigo-200 text-base label-text'>Confirm Password</span>
            </label>
            <input 
              type='password' 
          ...
          <Link to={'/login'} className='text-sm text-gray-300 hover:underline hover:text-indigo-600 mt-2 inline-block'>
